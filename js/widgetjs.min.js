(function (root, factory) {if (typeof define === 'function' && define.amd) { define(['jquery'], factory); } else { root.widgetjs = factory(root.$); } }(this, function ($) {/**
...
define('router/abstractSegment',[
	 ...
	 */
	var abstractSegment = objectjs.object.subclass(function(that, my) {
...
define('router/route',
	['./routeFactory', '../events', './routeMatchResult', 'jquery',	'./url',
		'objectjs'],
	function(routeFactory, events, routeMatchResult, jQuery, url, objectjs) {
		 ...
		 * @returns {route}
		 */
		var route = objectjs.object.subclass(function(that, my) {
...
define('router/hashLocation',[
	...
	'./url',
	'objectjs'
], function(jQuery, events, url, objectjs) {
	 ...
	 */
	var hashLocation = objectjs.object.subclass(function(that, my) {
...
define('router/router',
	...
	function(jQuery, events, route, url, hashLocation, objectjs) {
		...
		* @returns {{}}
		*/
		var router = objectjs.object.subclass(function(that, my) {
...
define('jquery', function () {   return $;});return require('core');}));